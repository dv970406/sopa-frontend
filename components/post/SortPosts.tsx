            ...
            <SortTab
                ...
                tabName={
                    postSortMethod === "likeCount" ? (
                        <>
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 0 20 20" fill="fuchsia">
                        ...
                        <>
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="fuchsia">
