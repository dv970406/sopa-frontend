...
export default function LoginHoverEvent() {
    ...
    return (
        ...
        >
            <button
                className="font-bold transition  text-sopa-accent hover:scale-110"
                onClick={goToLogin}
            >
                로그인
            </button>
            <AnimatePresence>
                {showSocialLogin ? (
                    <motion.div
                        className="absolute flex p-2 space-x-3 bg-white rounded-lg shadow-md  dark:bg-dark-default"
